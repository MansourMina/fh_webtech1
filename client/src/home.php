<div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-caption ">
    <div class="d-none d-sm-block">
      ...
      <p> <?php echo isset($_SESSION['email']) ?  "Welcome  <span style='color: white' class= 'fw-bold'>{$_SESSION['name']} </span>" : "" ?> </p>
        ...
        <div class="position-relative mt-5 d-block my-2">
          <div class="justify-content-center px-5 row g-0">
            ...
            <div class="col-12  col-lg-6 col-xl-4">
              <a class="btn btn-lg btn-outline-dark mx-3 my-2" aria-current="page" href="?rooms">More Details</a>
...
<div class=" text-center mt-5 ">
  ...
  <?php include_once "util/services.php" ?>
</div>
