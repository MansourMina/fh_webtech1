...
$services = [
  ...
  "hotel-spa" => ["id" => 2, "title" => "Hotel's Spa", "image" => "spa-service.jpg"],
  "fitness-center" => ["id" => 3, "title" => "Fitness Center", "image" => "fitness-service.jpg"],
  "bar" => ["id" => 4, "title" => "Bar", "image" => "bar-service.jpg"],
];
  ...
  <div class="container-fluid mx-0 px-0">
    <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="container my-5">
        <?php foreach (glob($folder . '/*.*') as $file) : ?>
          <? print_r($file) ?>
        <?php endforeach; ?>
