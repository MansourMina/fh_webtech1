                        ...
                        <div class="card mb-4 border-0">
                            <div class="card-body text-center">
                                <div class="image-container">
                                    <img src="<?php echo file_exists($_SESSION["image"]) ? $_SESSION["image"] : 'res/img/default.jpg' ?>" alt="Profile Image" class="rounded-circle" id="profile-img">
                                    <label class="overlay">
                                        Change Image
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div>
                                                ...
                                                <div class="input-group ">
                                                    ...
                                                    <button class="btn p-0 ms-4" type="button" id="firstnameButton" onclick="toggleReadOnly('firstnameButton', 'firstnameField', '<?php echo $_SESSION['firstname']; ?>','saveButton')"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div>
                                                ...
                                                <div class="input-group ">
                                                    ...
                                                    <button class="btn p-0 ms-4" type="button" id="lastnameButton" onclick="toggleReadOnly('lastnameButton', 'lastnameField', '<?php echo $_SESSION['lastname']; ?>','saveButton')"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                                            <path fill="<?= $GLOBALS["darkMode"] ? 'white' : 'black' ?>" d="M362.7 19.3L314.3 67.7 444.3 197.7l48.4-48.4c25-25 25-65.5 0-90.5L453.3 19.3c-25-25-65.5-25-90.5 0zm-71 71L58.6 323.5c-10.4 10.4-18 23.3-22.2 37.4L1 481.2C-1.5 489.7 .8 498.8 7 505s15.3 8.5 23.7 6.1l120.3-35.4c14.1-4.2 27-11.8 37.4-22.2L421.7 220.3 291.7 90.3z" />
                                                        </svg></button>
                                                </div>
                                            ...
                                            <div>
                                                ...
                                                <?php else : ?>
                                                    <div class="input-group ">
                                                        ...
                                                        <button class="btn p-0 ms-4" type="button" id="emailButton" onclick="toggleReadOnly('emailButton', 'emailField', '<?php echo $_SESSION['email']; ?>', 'saveButton')"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                                                <path fill="<?= $GLOBALS["darkMode"] ? 'white' : 'black' ?>" d="M362.7 19.3L314.3 67.7 444.3 197.7l48.4-48.4c25-25 25-65.5 0-90.5L453.3 19.3c-25-25-65.5-25-90.5 0zm-71 71L58.6 323.5c-10.4 10.4-18 23.3-22.2 37.4L1 481.2C-1.5 489.7 .8 498.8 7 505s15.3 8.5 23.7 6.1l120.3-35.4c14.1-4.2 27-11.8 37.4-22.2L421.7 220.3 291.7 90.3z" />
                                                            </svg></button>
                                                    </div>
                                                <?php endif; ?>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div>
                                                ...
                                                <div class="input-group ">
                                                    ...
                                                    <button class="btn p-0 ms-4" type="button" id="phoneButton" onclick="toggleReadOnly('phoneButton', 'phoneField', '<?php echo $_SESSION['phone_number']; ?>', 'saveButton')"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                                            <path fill="<?= $GLOBALS["darkMode"] ? 'white' : 'black' ?>" d="M362.7 19.3L314.3 67.7 444.3 197.7l48.4-48.4c25-25 25-65.5 0-90.5L453.3 19.3c-25-25-65.5-25-90.5 0zm-71 71L58.6 323.5c-10.4 10.4-18 23.3-22.2 37.4L1 481.2C-1.5 489.7 .8 498.8 7 505s15.3 8.5 23.7 6.1l120.3-35.4c14.1-4.2 27-11.8 37.4-22.2L421.7 220.3 291.7 90.3z" />
                                                        </svg></button>
                                                </div>
