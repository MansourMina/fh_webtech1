                        ...
                        <div class="card mb-4 border-0">
                            ...
                            <div class="card-body text-center">
                                <div class="image-container">
                                    <img src="<?php echo isset($_SESSION["image"]) ? $_SESSION["image"] : 'src/images/default.png' ?>" alt="src/images/default.png" class="rounded-circle img-circle" width="200" height="200" id="profile">
                                    <label class="overlay">
                                        Change Image
                                ...
                                <h5 class="my-3 mb-1 fw-bold"><?php echo "{$_SESSION["name"]}" ?></h5>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div>
                                                ...
                                                <div class="input-group ">
                                                    <input class="form-control my-2 text-secondary " type="text" value="<?php echo "{$_SESSION["name"]}" ?>" id="nameField" name="name" aria-label="Change name" aria-describedby="name-button" readonly>
                                                    <button class="btn p-0 ms-4" type="button" id="nameButton" onclick="toggleReadOnly('nameButton', 'nameField')"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
