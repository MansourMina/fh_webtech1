            ...
            <div class="booking">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input placeholder="John" type="text" id="name" name="name" class="form-control" value="<?php echo isset($_SESSION['email']) ? "{$_SESSION['name']}" : ''; ?>">
                    </div>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input placeholder="example@domain.com" type="email" id="email" name="email" class="form-control" autocomplete="on" value="<?php echo isset($_SESSION['email']) ? "{$_SESSION['email']}" : ''; ?>">
                    </div>
                    <div class="col">
                        <label for="phonenumber">Phone</label>
                        <input placeholder="+1 999 99-99-99" type="tel" id="phonenumber" name="phonenumber" class="form-control" value="<?php echo isset($_SESSION['email']) ? "{$_SESSION['phone_number']}" : ''; ?>">
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                ...
                <div class="d-flex mt-4 justify-content-end">
                  ...
                  border:0px solid #ccc !important;" href="?index">Cancel booking</a>
                </div>
