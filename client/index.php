...
$pages = [
    ...
    "book" => ["file" => "user/book.php", "title" => "Booking", "role" => [1],  "showBar" => true],
    "404" => ["file" => "404.php", "title" => "Page not Found", "role" => [0, 1, 2],  "showBar" => false],
    "members" => ["file" => "admin/members_management.php", "title" => "Users", "role" => [2],  "showBar" => true],
    "reservations_management" => ["file" => "admin/reservations_management.php", "title" => "Reservations-management", "role" => [2],  "showBar" => true],
    "members_profile" => ["file" => "admin/members_profile.php", "title" => "Members-profile", "role" => [2],  "showBar" => true]
];
